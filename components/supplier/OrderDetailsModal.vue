<template>
  <div v-if="isOpen && order" class="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
...
const updateStatus = async (newStatus) => {
  // Guardrail against undefined order IDs
